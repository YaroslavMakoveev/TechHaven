document.addEventListener('DOMContentLoaded', function () {
    const originalProducts = [
        { name: 'Беспроводная зарядка Infinix', price: 100, image: '../images/infinix.png' },
        { name: 'iPhone 13 Pro Max Case', price: 50, image: '../images/13case.png' },
        { name: 'Apple MagSafe', price: 400, image: '../images/magsafe.png' },
        { name: 'Переходник для айфона', price: 10, image: '../images/adapter.png' },
        { name: 'Беспроводная зарядка Infinix', price: 100, image: '../images/infinix.png' },
        { name: 'iPhone 13 Pro Max Case', price: 50, image: '../images/13case.png' },
        { name: 'Apple MagSafe', price: 400, image: '../images/magsafe.png' },
        { name: 'Переходник для айфона', price: 10, image: '../images/adapter.png' },
